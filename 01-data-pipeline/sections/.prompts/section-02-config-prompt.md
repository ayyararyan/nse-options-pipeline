...
Generate content for section `section-02-config` (filename: `section-02-config.md`).
...
for `section-02-config` to understand what this section should contain.
...
`/Users/aryanayyar/Liquidity Metrics/01-data-pipeline/sections/section-02-config.md`
