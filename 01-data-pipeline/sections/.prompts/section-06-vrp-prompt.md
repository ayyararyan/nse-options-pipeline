...
Generate content for section `section-06-vrp` (filename: `section-06-vrp.md`).
...
for `section-06-vrp` to understand what this section should contain.
...
`/Users/aryanayyar/Liquidity Metrics/01-data-pipeline/sections/section-06-vrp.md`
