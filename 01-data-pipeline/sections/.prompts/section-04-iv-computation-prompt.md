...
Generate content for section `section-04-iv-computation` (filename: `section-04-iv-computation.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/aryanayyar/Liquidity Metrics/01-data-pipeline/claude-plan.md` - Full implementation plan
2. `/Users/aryanayyar/Liquidity Metrics/01-data-pipeline/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/aryanayyar/Liquidity Metrics/01-data-pipeline/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-04-iv-computation` to understand what this section should contain.
...
`/Users/aryanayyar/Liquidity Metrics/01-data-pipeline/sections/section-04-iv-computation.md`
