...
Generate content for section `section-07-ofi` (filename: `section-07-ofi.md`).
...
for `section-07-ofi` to understand what this section should contain.
...
`/Users/aryanayyar/Liquidity Metrics/01-data-pipeline/sections/section-07-ofi.md`
